...
<p className="text-gray-600 dark:text-gray-400 max-w-md">
  Full Stack Developer & DevOps Specialist building production‑ready web and mobile apps with MERN, Next.js, React Native, LAMP, and TypeScript; experienced across AWS, Azure, GCP, and DigitalOcean, with tooling like GitHub, Docker, and Postman.
</p>
        ...
        >
          <p className="text-gray-600 dark:text-gray-400 flex items-center justify-center space-x-1">
            <span>© {currentYear} Ateeshay Rawat</span>
          </p>
        </motion.div>
      </div>
    </footer>
