...
const skillCategories = [
  { name: 'Programming Languages', skills: MERGED.programming, color: 'from-blue-500 to-cyan-500' },
  { name: 'Frontend', skills: MERGED.frontend, color: 'from-green-500 to-emerald-500' },
  { name: 'Backend', skills: MERGED.backend, color: 'from-purple-500 to-violet-500' },
  { name: 'Databases', skills: MERGED.databases, color: 'from-orange-500 to-red-500' },
  { name: 'Cloud & DevOps', skills: MERGED.cloud, color: 'from-pink-500 to-rose-500' },
  { name: 'Tools', skills: MERGED.tools, color: 'from-indigo-500 to-blue-500' }
]
